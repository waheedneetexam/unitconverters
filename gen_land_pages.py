...
STATES = [
    {
        ...
        "units": [
            ...
            ("bigha_pucca", "Bigha (Pucca)",  "Bigha",   27000,    "Official standard for land records"),
            ("bigha_kachha","Bigha (Kachha)", "Bigha K", 9075,     "1/3 of Pucca Bigha, used locally"),
            ("biswa_pucca", "Biswa (Pucca)",  "Biswa",   1350,     "1/20 of Pucca Bigha"),
    ...
    },
    {
        ...
        "units": [
            ...
            ("sqmeter", "Square Meter", "sq m",   10.7639, ""),
            ("acre",    "Acre",         "Acre",   43560,   ""),
            ("killa",   "Killa",        "Killa",  43560,   "Equal to 1 Acre"),
            ("kanal",   "Kanal",        "Kanal",  5445,    "1/8 of an Acre"),
            ("marla",   "Marla",        "Marla",  272.25,  "1/20 of a Kanal"),
            ("bigha",   "Bigha",        "Bigha",  9070,    "~2 Bighas = 1 Acre in some areas"),
            ("hectare", "Hectare",      "ha",     107639,  ""),
        ],
    },
    {
        ...
        "name": "Bihar",
        "short": "BR",
        "desc": "Bihar uses the Katha and Dhur system, very common in agricultural land deals.",
        "units": [
            ("sqft",    "Square Feet",  "sq ft",  1,       ""),
            ("sqmeter", "Square Meter", "sq m",   10.7639, ""),
            ("acre",    "Acre",         "Acre",   43560,   ""),
            ("bigha",   "Bigha",        "Bigha",  27220,   "Standard Bihar Bigha"),
            ("katha",   "Katha",        "Katha",  1361,    "1/20 of Bigha"),
            ("dhur",    "Dhur",         "Dhur",   68.05,   "1/20 of Katha"),
            ("hectare", "Hectare",      "ha",     107639,  ""),
        ],
    },
    {
        ...
        "units": [
            ...
            ("sqmeter", "Square Meter", "sq m",   10.7639, ""),
            ("acre",    "Acre",         "Acre",   43560,   ""),
            ("bigha",   "Bigha",        "Bigha",  14400,   "Standard West Bengal Bigha"),
    ...
    },
    {
        ...
        "units": [
            ...
            ("sqmeter",     "Square Meter",   "sq m",   10.7639, ""),
            ("acre",        "Acre",           "Acre",   43560,   ""),
            ("bigha_pucca", "Bigha (Pucca)",  "Bigha",  27225,   "Official Pucca Bigha"),
            ("bigha_kachha","Bigha (Kachha)", "Bigha K",17424,   "Kachha Bigha"),
    ...
    },
    {
        ...
        "units": [
            ...
            ("sqmeter", "Square Meter", "sq m",   10.7639, ""),
            ("acre",    "Acre",         "Acre",   43560,   ""),
            ("bigha",   "Bigha",        "Bigha",  12000,   "MP Bigha (smaller than UP)"),
    ...
    },
    {
        ...
        "units": [
            ...
            ("sqmeter", "Square Meter", "sq m",   10.7639, ""),
            ("acre",    "Acre",         "Acre",   43560,   ""),
            ("vigha",   "Vigha",        "Vigha",  17424,   "Gujarat Vigha"),
    ...
    },
    {
        ...
        "units": [
            ("sqft",    "Square Feet",  "sq ft",  1,       ""),
            ("sqmeter", "Square Meter", "sq m",   10.7639, ""),
            ("acre",    "Acre",         "Acre",   43560,   "40 Gunthas = 1 Acre"),
            ("guntha",  "Guntha",       "Guntha", 1089,    "1/40 of an Acre"),
            ("hectare", "Hectare",      "ha",     107639,  ""),
        ],
    },
    {
        ...
        "units": [
            ...
            ("sqmeter", "Square Meter", "sq m",   10.7639, ""),
            ("acre",    "Acre",         "Acre",   43560,   ""),
            ("ground",  "Ground",       "Ground", 2400,    "Standard unit for residential plots in Chennai"),
            ("cent",    "Cent",         "Cent",   435.6,   "100 Cents = 1 Acre"),
            ("hectare", "Hectare",      "ha",     107639,  ""),
        ],
    },
    {
        "slug": "himachal-uttarakhand",
        "name": "Himachal Pradesh & Uttarakhand",
        "short": "HP/UK",
        "desc": "Due to hilly terrain, land units in Himachal Pradesh and Uttarakhand are significantly smaller than plains states.",
        "units": [
            ("sqft",    "Square Feet",  "sq ft",  1,       ""),
            ("sqmeter", "Square Meter", "sq m",   10.7639, ""),
            ("acre",    "Acre",         "Acre",   43560,   ""),
            ("bigha",   "Bigha",        "Bigha",  8712,    "Hilly terrain Bigha (smaller)"),
